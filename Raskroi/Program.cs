...
namespace Raskroi
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //Еще планировал сделать, чтобы не только слева-направо был расчет,
            //а вообще по офсету или справа-налевоо минимум, последний способ
            ...
            //1. Минимальный остаток, когда просто упорядовачиваем потребность от большей к меньшей палке,
            ...
            //По сути получился такой себе прототип)) Даже интерфейсы не везде навешал

            //Но сама суть подхода недеюсь видна, MVP - в продакшен коде, естественно все плюшки бы навешал
